...
import { Card,Button,Text, Paragraph ,Switch, Headline} from 'react-native-paper';
import   jwt_decode  from "jwt-decode";
import {
  StyleSheet,View,TextInput,Alert,TouchableOpacity,LogBox, ImageBackground,Image,ScrollView
} from 'react-native';
...
function App({navigation,route}:any): JSX.Element {
  ...
  return(
    ...
    <SafeAreaView>
   <ImageBackground source={require('../Images/Loginbackground.png')} style={styles.backgroundImage}>
    <ScrollView>
    <Image source={require('../Images/LoginImage.png')} style={styles.loginImage}></Image>
    <View style={{alignItems:'center'}}>
        ...
        <Icon name='lock' size={20} style={[styles.inputIcon,{width:40,paddingLeft:13}]}/>
        <TextInput placeholder='Password' style={[styles.input]} onChangeText={(pass)=>(setPass(pass))} secureTextEntry={PasswordDisable}/>
